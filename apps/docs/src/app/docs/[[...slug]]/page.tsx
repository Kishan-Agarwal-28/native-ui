    ...
    >
      <DocsBody className="bg-white text-slate-900 dark:bg-[#0b0d12] dark:text-white">
        <div className="flex items-center justify-between gap-2">
          <div className="flex-col flex-1 gap-10 items-baseline justify-center">
            <DocsTitle className="mb-2 font-semibold">
              {page.data.title}
            </DocsTitle>
          ...
          components={{
            ...
            h3: ({ className, ...props }) => (
              <h3
                className={cn(
                  className,
                  "mb-6 mt-10 scroll-mt-20 font-medium text-slate-900 dark:text-white",
                )}
                {...props}
              />
            ),
    ...
    <div className="flex items-center gap-2">
      {neighbours.previous || isManualInstallation ? (
        <Button
          variant="outline"
          size="icon"
          className="border-border/70 size-8"
          asChild
        >
      ...
      {neighbours.next || isManualInstallation ? (
        ...
        >
          <Link
            ...
            target={
              neighbours.next?.url.startsWith("https://foundedlabs.com")
                ? "_blank"
                : undefined
            }
          >
